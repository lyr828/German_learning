...
import { ArrowLeft, BookOpen, FileText, Trophy } from 'lucide-vue-next'
...
const stats = computed(() => ({
  ...
  completed: progress.value.reading.completed,
  ...
  <div class="min-h-screen flex flex-col bg-gray-50">
    ...
    <main class="flex-1">
      <section class="bg-gradient-to-r from-[#003366] to-[#0055AA] text-white py-8">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div class="flex items-center justify-between">
            ...
            <h1 class="text-2xl md:text-3xl font-bold">阅读练习</h1>
            <div class="w-20"></div>
          </div>
        </div>
      </section>
      ...
      <section class="py-8 bg-gray-50">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <h2 class="text-xl font-bold text-[#003366] mb-6">阅读题目列表</h2>
