...
import { ArrowLeft, Mic, FileText, Trophy } from 'lucide-vue-next'
...
const stats = computed(() => ({
  ...
  completed: progress.value.speaking.completed,
  ...
  <div class="min-h-screen flex flex-col bg-gray-50">
    ...
    <main class="flex-1">
      <section class="bg-gradient-to-r from-[#003366] to-[#0055AA] text-white py-8">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div class="flex items-center justify-between">
            ...
            <h1 class="text-2xl md:text-3xl font-bold">口语练习</h1>
            <div class="w-20"></div>
          </div>
        </div>
      </section>
          ...
          <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
            ...
            <div class="bg-white rounded-xl shadow-md p-6 flex items-center space-x-4">
              <div class="w-14 h-14 bg-green-100 rounded-full flex items-center justify-center">
                <Mic class="w-7 h-7 text-green-600" />
              </div>
              <div>
      ...
      <section class="py-8 bg-gray-50">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <h2 class="text-xl font-bold text-[#003366] mb-6">口语题目列表</h2>
              ...
              <div class="p-5">
                ...
                <div class="flex items-center justify-between">
                  <div class="flex items-center space-x-2 text-sm text-gray-400">
                    ...
                    <span>|</span>
                    <span>{{ question.parts.length }}部分</span>
                  </div>
